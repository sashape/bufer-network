...
static EN: Table = &[
    ...
    ("image_too_large", "The image is too large to send."),
...
static RU: Table = &[
    ...
    ("image_too_large", "Картинка слишком большая для отправки."),
...
static FR: Table = &[
    ...
    ("image_too_large", "L'image est trop grande pour être envoyée."),
...
static DE: Table = &[
    ...
    ("image_too_large", "Das Bild ist zu groß zum Senden."),
...
static ES: Table = &[
    ...
    ("image_too_large", "La imagen es demasiado grande para enviarla."),
