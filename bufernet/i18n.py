"""UI localization: en, ru, fr, de, es."""
import ctypes
import locale
...
_STRINGS = {
    "en": {
        ...
        "rollout_exe_only": "Update rollout only works from the built BuferNet.exe.",
        "rollout_all_current": "Every computer already has v{version} or newer.",
        "rollout_confirm": "Send BuferNet v{version} to: {names}?\n"
        ...
        "update_skip_old": "Update v{version} from {name} is not newer than "
                           "v{current} — skipped",
        "update_skip_noexe": "Update v{version} from {name} skipped: "
                             "not running from an exe",
        ...
        "err_no_ack": "receiver did not confirm — it may run a version without "
                      "update support; update it manually once",
    },
    "ru": {
        ...
        "rollout_exe_only": "Раскатка обновления работает только из собранного BuferNet.exe.",
        "rollout_all_current": "У всех компьютеров в сети уже v{version} или новее.",
        "rollout_confirm": "Отправить BuferNet v{version} на: {names}?\n"
        ...
        "update_skip_old": "Обновление v{version} от {name} не новее моей "
                           "v{current} — пропущено",
        "update_skip_noexe": "Обновление v{version} от {name} пропущено: "
        ...
        "err_no_ack": "получатель не подтвердил приём — возможно, там версия без "
    ...
    "fr": {
        ...
        "rollout_exe_only": "Le déploiement ne fonctionne que depuis le BuferNet.exe compilé.",
        "rollout_all_current": "Tous les ordinateurs ont déjà la v{version} ou plus récente.",
        "rollout_confirm": "Envoyer BuferNet v{version} à : {names} ?\n"
        ...
        "update_skip_old": "Mise à jour v{version} de {name} pas plus récente que "
                           "la v{current} — ignorée",
        "update_skip_noexe": "Mise à jour v{version} de {name} ignorée : "
                             "lancé hors exe",
        ...
        "err_no_ack": "le destinataire n'a pas confirmé — version sans prise en "
                      "charge des mises à jour ? Mettez-le à jour manuellement une fois",
    },
    "de": {
        ...
        "rollout_exe_only": "Die Update-Verteilung funktioniert nur aus der "
                            "kompilierten BuferNet.exe.",
        "rollout_all_current": "Alle Computer haben bereits v{version} oder neuer.",
        "rollout_confirm": "BuferNet v{version} an {names} senden?\n"
        ...
        "update_skip_old": "Update v{version} von {name} ist nicht neuer als "
                           "v{current} — übersprungen",
        "update_skip_noexe": "Update v{version} von {name} übersprungen: "
                             "nicht aus einer exe gestartet",
        ...
        "err_no_ack": "Empfänger hat nicht bestätigt — evtl. Version ohne "
                      "Update-Unterstützung; einmal manuell aktualisieren",
    },
    "es": {
        ...
        "rollout_exe_only": "La distribución solo funciona desde el BuferNet.exe compilado.",
        "rollout_all_current": "Todos los equipos ya tienen la v{version} o más reciente.",
        "rollout_confirm": "¿Enviar BuferNet v{version} a: {names}?\n"
        ...
        "update_skip_old": "La actualización v{version} de {name} no es más nueva "
                           "que la v{current} — omitida",
        "update_skip_noexe": "Actualización v{version} de {name} omitida: "
                             "no se ejecuta desde un exe",
        ...
        "err_no_ack": "el receptor no confirmó — puede ser una versión sin soporte "
                      "de actualizaciones; actualízalo manualmente una vez",
    },
}

_current = "en"

# Windows primary LANGID -> language code
_LANGID_MAP = {0x09: "en", 0x19: "ru", 0x0C: "fr", 0x07: "de", 0x0A: "es"}


def detect_system_language() -> str:
    try:
        langid = ctypes.windll.kernel32.GetUserDefaultUILanguage()
        return _LANGID_MAP.get(langid & 0x3FF, "en")
